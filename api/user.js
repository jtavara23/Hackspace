...
// información de las contraseñas que es algo muy sensible.
...
router.route('/users/:username')
    .put(Access,function (req, res) {
        ...
        User.findOne({ username: username })
            .then(function (usuario) {
                if (new_email) {// Si hay actualizacion en el email
                    // Registro de nuevo email
                    usuario.email = new_email;
                }
                if (new_password) {// Si hay actualizacion en la contra
                    // Encriptacion de contraseña
                    var saltRounds = 10;
                    var salt = bcrypt.genSaltSync(saltRounds);
                ...
                if (new_nombres) {// Si hay actualizacion en los nombres 
                ...
                if (new_username) {// Si hay actualizacion en el username   
...
//==========================DELETE USER AND HIS SPECIALITY
router.route('/speciality/:username')
